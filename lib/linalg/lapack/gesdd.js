...
function dgesdd(mA, m, n) {
    ...
    var U = new Float64Array(em.HEAPF64.buffer, pU, m * n);
    var VT = new Float64Array(em.HEAPF64.buffer, pVT, n * n);
    A.set(mA);
    ...
    pwork = em._malloc(worksize * common_1.SIZE_DOUBLE);
    var WORK = new Float64Array(em.HEAPF64.buffer, pwork, worksize);
